/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fb417a8ecc79e514e10eb0e761ff113e)
// Runtime types generated with workerd@1.20260120.0 2025-04-01 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		BATTLE_WEBSOCKET: DurableObjectNamespace<import("./src/index").BattleWebsocket>;
		BATTLE_CHAT: DurableObjectNamespace<import("./src/index").BattleChat>;
		BATTLE_DONE_WORKFLOW: Workflow<Parameters<import("./src/index").BattleDoneWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLERK_PUBLISHABLE_KEY" | "CLERK_SECRET_KEY" | "DATABASE_URL" | "DOPPLER_CONFIG" | "DOPPLER_ENVIRONMENT" | "DOPPLER_PROJECT">> {}
}
