// Adapted from shadcn/ui (MIT): https://ui.shadcn.com/docs/components/radix/sidebar
"use client";
  ...
  return (
    <SheetPortal>
      ...
      >
        {children}
        {showCloseButton && (
          <SheetPrimitive.Close className="rpg-button rpg-button-ghost rpg-button-icon absolute top-2 right-2">
