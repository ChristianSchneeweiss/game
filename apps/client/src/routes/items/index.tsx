          ...
          aside={
            <RpgInset variant="parchment" className="p-5">
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="mt-5 w-full border-[#3ca6ff]/30 bg-[#3ca6ff]/10 text-[#9bd0ff] hover:bg-[#3ca6ff]/18"
              >
                <Link to="/dungeons">
                  Find more gear
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex items-start gap-4">
                      <div className="rpg-icon-frame h-14 w-14 text-2xl text-[#ead7aa]">
                        <EquipmentIcon
                          type={item.type}
                        />
                      </div>
                    ...
                    <RpgBadge>T{item.item.tier}</RpgBadge>
                  </div>
            ...
            <RpgEmptyState
              ...
              action={
                <Button
                  ...
                  variant="outline"
                  size="lg"
                  className="border-[#3ca6ff]/30 bg-[#3ca6ff]/10 text-[#9bd0ff] hover:bg-[#3ca6ff]/18"
                >
                  <Link to="/dungeons">
                    Explore dungeons
                    <ArrowRight className="h-4 w-4" />
