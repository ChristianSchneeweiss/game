                ...
                >
                  ...
                  <div className="mb-4 flex items-start justify-between">
                    ...
                    >
                      ...
                      >
                        ...
                        {entityAttributes && (
                          <HoverCardContent className="border-slate-600 bg-slate-800">
                  ...
                  <div className="space-y-2">
                    ...
                    {entity.spells.map((spell) => {
                      ...
                      const cooldown = currentStats.cooldowns.get(
                        spell.config.id,
                      );
            ...
            {enemies.map((entity) => {
              ...
              return (
                <div
                  key={entity.id}
                  className={cn(
                    "relative rounded-xl border-2 bg-gradient-to-br from-red-900/20 to-slate-900/90 p-6 shadow-2xl backdrop-blur-sm transition-all duration-300",
                    currentStats?.flags.casting &&
                      "border-blue-400 shadow-2xl shadow-blue-400/20",
                    currentStats?.deltaHealth > 0 &&
                      "border-green-400 shadow-2xl shadow-green-400/20",
