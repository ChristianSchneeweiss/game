...
The production migration is implemented locally on `codex/production-v1`. **It has not been deployed or qualified for release.** See the [remaining release checklist](docs/production/checklist.md) and [candidate evidence](docs/production/evidence.md).
...
- [Current equipment](docs/features/equipment-milestone.md), [dungeon runs](docs/features/dungeon-run-milestone.md), and [weighted routes](docs/features/branching-dungeon-milestone.md) document the implemented player loop.
- [Game library](docs/features/library.md) covers the full content catalogue, targeting, enemy kits and drops, and local balance previews.
...
The [documentation index](docs/README.md) collects current guides. Retired plans, audit findings, prototype research and presentation evidence remain in Git history. The release checklist is the active source for remaining work.
