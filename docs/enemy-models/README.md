...
See [the supplementary source research](../enemy-model-alternatives.md) for other candidates and acquisition details. The mapping in this document supersedes that research's earlier fishfolk/golem gaps.
