...
[Spell preview evidence](might-assessments/spell-previews-v2.json) contains all
...
[Paired probe results](might-assessments/passive-probes-v2.json) cover **1,792
...
[Enemy results](might-assessments/enemy-probes-v2.json) cover **1,408 battles**:
...
[The v1 assessment snapshot](might-assessments/assessments-v1.json) preserves all
75 previous numbers and their original conditions/rationales. The earlier
[v1 notes](might-assessments-v1.md) and [v1 enemy data](might-assessments/enemy-probes.json)
are historical evidence, not results from this reference.
