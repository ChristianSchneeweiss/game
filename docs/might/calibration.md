...
It complements the [research report](research.md).
...
The [probe output](calibration/engine-results.json)
...
[engine-results.json](calibration/engine-results.json)
...
or a database. The [detailed measurement notes](calibration/engine-probes.md)
