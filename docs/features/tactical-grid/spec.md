...
- The original publication was a design deliverable. The subsequent [local implementation](implementation.md) covers the complete conversion and records its verification; deployment qualification and the separately deferred tier/scaling work are not established by publishing this specification.
