...
[late-mid-game v3 assessment](../might/assessments.md), with individual rationales
and versioned references for every family and equipment slot. The shared reference
uses a level-31, 160-point budget, real E–B gear, 550–800 HP and 6/12-round
encounters, with no synthetic defense or critical-chance allowance. Fresh spell,
passive, equipment-slot and enemy evidence is linked there; every rating remains
provisional. Seven values changed and 131 were reviewed and retained. Future missing assessments display
**Might — · Unrated**. A real zero assessment displays **E · Might 0**.
Estimated assessments remain provisional metadata; the catalogue and details
omit the Estimated label and explanation. Both Estimated and Assessed values
participate in numeric sorting. The Library exposes only the
