...
[GitHub issue #2](https://github.com/ChristianSchneeweiss/game/issues/2).
The feature is implemented locally; the [implementation record](implementation.md)
describes delivered behavior and pending browser and deployment verification.
The [complete specification](spec.md) preserves the accepted requirements and
testing boundaries. The notes below record the design discussion.
