...
> Historical content snapshot. Later [equipment](../../equipment-milestone.md), [route balance](../../branching-dungeon-milestone.md), and [combat repairs](../battle-audit/verification-results.md) supersede conflicting mechanics/acquisition details below. See the [current project guide](../../../README.md).
